...
var addressInit = function(_cmbClass,_cmbProvince, _cmbCity, _cmbArea)
{
	var cmbProvince = document.getElementById(_cmbProvince);
	var cmbClass = document.getElementById(_cmbClass);
	...
	function changeClass()
	{
		...
		var item = cmbClass.options[cmbClass.selectedIndex].obj;
		for(var i=0; i<item.provinceList.length; i++)
		{
			cmbAddOption(cmbProvince, item.provinceList[i].name, item.provinceList[i]);
		}
	...
	{
		cmbAddOption(cmbClass, classList[i].name, classList[i]);
	}
	
	changeClass();
	cmbClass.onchange = changeClass;
}
...
{name:'中国大陆',
	provinceList:[
		{name:'北京', cityList:[		   
		{name:'北京', areaList:['东城区','西城区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区','密云区','延庆区']},		   
		]},
		{name:'上海', cityList:[		   
		{name:'上海', areaList:['黄浦区','徐汇区','长宁区','静安区','普陀区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','奉贤区','崇明区']},
		]},
		{name:'天津', cityList:[		   
		{name:'天津', areaList:['和平区','河东区','河西区','南开区','河北区','红桥区','东丽区','西青区','津南区','北辰区','武清区','宝坻区','滨海区','宁河区','静海区','蓟　县']},
		]},
		{name:'重庆', cityList:[		   
		{name:'重庆', areaList:['万州区','涪陵区','渝中区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','万盛区','双桥区','渝北区','巴南区','黔江区','长寿区','綦江县','潼南县','铜梁县','大足县','荣昌县','璧山县','梁平县','城口县','丰都县','垫江县','武隆县','忠　县','开　县','云阳县','奉节县','巫山县','巫溪县','石柱县','秀山县','酉阳县','彭水县','江津市','合川市','永川市','南川市']}
		]},
		{name:'四川', cityList:[		   
		...
		{name:'贵州', cityList:[		   
		{name:'贵阳市', areaList:['南明区','云岩区','花溪区','乌当区','白云区','开阳县','息烽县','修文县','观山湖区','清镇市']},		   
		{name:'六盘水市', areaList:['钟山区','六枝特区','水城县','盘　县']},		   
		{name:'遵义市', areaList:['红花岗区','汇川区','遵义县','桐梓县','绥阳县','正安县','道真县','务川县','凤冈县','湄潭县','余庆县','习水县','赤水市','仁怀市']},		   
		{name:'安顺市', areaList:['西秀区','平坝县','普定县','镇宁县','关岭县','紫云县']},		   
		{name:'铜仁地区', areaList:['碧江区','江口县','玉屏县','石阡县','思南县','印江县','德江县','沿河县','松桃县','万山特区']},		   
		{name:'黔西南布依族苗族自治州', areaList:['兴义市','兴仁县','普安县','晴隆县','贞丰县','望谟县','册亨县','安龙县']},		   
		{name:'毕节地区', areaList:['毕节市','大方县','黔西县','金沙县','织金县','纳雍县','威宁县','赫章县']},		   
		{name:'黔东南苗族侗族自治州', areaList:['凯里市','黄平县','施秉县','三穗县','镇远县','岑巩县','天柱县','锦屏县','剑河县','台江县','黎平县','榕江县','从江县','雷山县','麻江县','丹寨县']},		   
		{name:'黔南布依族苗族自治州', areaList:['都匀市','福泉市','荔波县','贵定县','瓮安县','独山县','平塘县','罗甸县','长顺县','龙里县','惠水县','三都县']}
		]},
		{name:'云南', cityList:[		   
		...
		{name:'广东', cityList:[		   
		{name:'广州市', areaList:['荔湾区','越秀区','海珠区','天河区','白云区','黄埔区','番禺区','花都区','南沙区','萝岗区','增城市','从化市']},		   
		...
		{name:'茂名市', areaList:['茂南区','电白县','高州市','化州市','信宜市']},		   
		...
		{name:'清远市', areaList:['清城区','佛冈县','阳山县','连山县','连南县','清新县','英德市','连州市']},		   
		...
		{name:'柳州市', areaList:['城中区','鱼峰区','柳南区','柳北区','柳江县','柳城县','鹿寨县','融安县','融水县','三江县']},		   
		{name:'桂林市', areaList:['秀峰区','叠彩区','象山区','七星区','雁山区','阳朔县','临桂县','灵川县','全州县','兴安县','永福县','灌阳县','龙胜县','资源县','平乐县','荔蒲县','恭城县']},		   
		{name:'梧州市', areaList:['万秀区','龙圩区','长洲区','苍梧县','藤　县','蒙山县','岑溪市']},		   
		...
		{name:'玉林市', areaList:['玉州区','福绵区','容　县','陆川县','博白县','兴业县','北流市']},		   
		...
		{name:'嘉峪关市', areaList:['新城区','峪泉区','文殊镇','雄关区','镜铁区','长城区']},		   
		{name:'金昌市', areaList:['金川区','永昌县']},		   
		{name:'白银市', areaList:['白银区','平川区','靖远县','会宁县','景泰县']},		   
		{name:'天水市', areaList:['秦城区','麦积区','清水县','秦安县','甘谷县','武山县','张家川县']},		   
		{name:'武威市', areaList:['凉州区','民勤县','古浪县','天祝县']},		   
		{name:'张掖市', areaList:['甘州区','肃南县','民乐县','临泽县','高台县','山丹县']},		   
		{name:'平凉市', areaList:['崆峒区','泾川县','灵台县','崇信县','华亭县','庄浪县','静宁县']},		   
		{name:'酒泉市', areaList:['肃州区','金塔县','瓜州县','肃北县','阿克塞县','玉门市','敦煌市']},		   
		...
		{name:'临夏回族自治州', areaList:['临夏市','临夏县','康乐县','永靖县','广河县','和政县','东乡县','积石山县']},		   
		...
		{name:'安徽', cityList:[		   
		{name:'合肥市', areaList:['瑶海区','庐阳区','蜀山区','包河区','长丰县','肥东县','肥西县','巢湖市','庐江县']},		   
		{name:'芜湖市', areaList:['镜湖区','弋江区','三山区','鸠江区','芜湖县','繁昌县','南陵县','无为县']},		   
		{name:'蚌埠市', areaList:['龙子湖区','蚌山区','禹会区','淮上区','怀远县','五河县','固镇县']},		   
		{name:'淮南市', areaList:['大通区','田家庵区','谢家集区','八公山区','潘集区','凤台县','寿  县']},		   
		{name:'马鞍山市', areaList:['博望区','含山区','花山区','雨山区','当涂县','和  县']},		   
		{name:'淮北市', areaList:['杜集区','相山区','烈山区','濉溪县']},		   
		{name:'铜陵市', areaList:['铜陵市','铜官区','郊　区','枞阳县']},		   
		...
		{name:'宿州市', areaList:['埇桥区','砀山县','萧　县','灵璧县','泗　县']},		   
			   
		{name:'六安市', areaList:['金安区','裕安区','霍邱县','舒城县','金寨县','霍山县']},		   
...
{name:'台湾地区',
	provinceList:[
		{name:'台湾',cityList:[
			{name:'连江', areaList:['北竿','东引','莒光','南竿']},
			{name:'高雄', areaList:['阿莲','大寮','大社','大树','凤山','冈山','湖内','甲仙','苓雅','林园','六龟','路竹','茂林','美浓','弥陀','那玛夏','内门','鸟松','桥头','茄萣','旗山','仁武','杉林','桃源','田寮','燕巢','永安','梓官','鼓山','楠梓','前金','前镇','旗津','三民','小港','新兴','盐埕','左营']},
			{name:'花莲', areaList:['丰滨','凤林','富里','光复','花莲','卓溪','吉安','瑞穗','寿丰','新城','秀林','太鲁','万荣','玉里']},
			{name:'嘉义', areaList:['东区','西区','阿里山','鹿草','布袋','大林','大埔','东石','番路','中埔','竹崎','六脚','梅山','民雄','朴子','水上','溪口','新港','太保','义竹']},
			{name:'基隆', areaList:['安乐','暖暖','七堵','仁爱','信义','中山','中正']},
			{name:'金门', areaList:['金城','金湖','金宁','金沙','烈屿','乌坵']},
			{name:'苗栗', areaList:['太湖','公馆','后龙','竹南','卓兰','苗栗','南庄','三湾','三义','狮潭','西湖','泰安','铜锣','通宵','头份','头屋','苑里','造桥']},
			{name:'南投', areaList:['草屯','国姓','中寮','竹山','集集','鹿谷','名间','南投','埔里','仁爱','水里','信义','鱼池']},
			{name:'澎湖', areaList:['白沙','七美','湖西','马公','西屿','望安']},
			{name:'屏东', areaList:['长治','潮州','车城','春日','东港','枋寮','枋山','高树','恒春','竹田','佳冬','九如','崁顶','来义','里港','林边','麟洛','琉球','玛家','满洲','牡丹','南州','内埔','屏东','三地门','狮子','新埤','新园','泰武','万丹','万峦','雾台','盐埔']},
			{name:'台北', areaList:['北投','大安','大同','南港','内湖','信义','士林','松山','万华','文山','中山','中正']},
			{name:'台东', areaList:['卑南','长滨','成功','池上','达仁','大武','东河','关山','海端','金峰','兰屿','鹿野','绿岛','台东','太麻里','延平']},
			{name:'台南', areaList:['安定','白河','北门','大内','东山','关庙','官田','归仁','后壁','佳里','将军','六甲','柳营','龙崎','麻豆','南化','楠西','七股','仁德','善化','山上','下营','西港','新化','新市','新营','学甲','盐水','永康','玉井','左镇','安南','安平','北区','东区','南区','中西']},
			{name:'台中', areaList:['大安','大肚','大甲','大里','大雅','东势','丰原','和平','后里','龙井','清水','沙鹿','神冈','石冈','太平','潭子','外埔','雾峰','梧栖','乌日','新社','北区','北屯','东区','南区','南屯','西区','西屯','中区']},
			{name:'桃园', areaList:['八德','大溪','大园','复兴','观音','龟山','中坜','龙潭','芦竹','平镇','新屋','桃园','杨梅']},
			{name:'新北', areaList:['八里','板桥','谈水','贡寮','中和','金山','林口','芦洲','坪林','平溪','瑞芳','三重','三芝','三峡','深坑','石碇','石门','双溪','树林','汐止','新店','新庄','泰山','土城','万里','五股','乌来','莺歌','永和']},
			{name:'新竹', areaList:['东区','北区','香山','宝山','北埔','芎林','峨眉','关西','横山','湖口','竹北','竹东','尖石','新丰','新埔','五峰']},
			{name:'宜兰', areaList:['大同','冬山','壮围','礁溪','罗东','南澳','三星','苏澳','头城','五结','宜兰','员山','钓鱼']},
			{name:'云林', areaList:['褒忠','北港','莿桐','大埤','东势','斗六','斗南','二仑','古坑','虎尾','口湖','林内','仑背','麦寮','水林','四湖','西螺','台西','土库','元长']},
			{name:'彰化', areaList:['北斗','大城','大村','二林','二水','芳苑','芬园','福兴','和美','花坛','彰化','竹塘','鹿港','埤头','埔心','埔盐','伸港','社头','线西','溪湖','溪州','秀水','田中','田尾','永靖','员林']},
		]}		
	]},
{name:'海外其他',
	provinceList:[
